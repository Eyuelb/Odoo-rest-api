    ...
    return(
        <div>
            ...
            <div className="lg:flex justify-between items-center mb-6">
              ...
              <button className=" focus:outline-none rounded-lg px-6 py-2 font-semibold shadow">View Logs</button>
            </div>

            <div className="flex flex-wrap -mx-3 mb-20">

              <div className="w-1/2 xl:w-1/4 px-3">
                <div className="w-full rounded-lg flex items-center p-6 mb-6 xl:mb-0">
              ...
              <div className="w-1/2 xl:w-1/4 px-3">
                <div className="w-full rounded-lg flex items-center p-6">
                  <svg className="w-16 h-16 fill-current mr-4 hidden lg:block" viewBox="0 0 20 20">
            ...
            <div className="flex flex-wrap -mx-3">
              ...
              <div className="w-full xl:w-1/3 px-3">
                ...
                <div className="w-full border rounded-lg p-4 mb-8 xl:mb-0">
              ...
              <div className="w-full xl:w-1/3 px-3">
                ...
                <div className="w-full border rounded-lg p-4">
                  <div className="w-full border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
                      <div>
